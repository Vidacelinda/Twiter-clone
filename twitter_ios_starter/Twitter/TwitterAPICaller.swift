...
class TwitterAPICaller:BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "GEKQrOEhoFCVvon0CxLKQHCwG", consumerSecret: "HMUPfsuAGknjmNT8gJqyuJETYi1AsgFt5kwaE0boMdicNXXawR")
    var loginSuccess: (() -> ())?
